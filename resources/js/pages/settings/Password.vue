        ...
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall
                    ...
                    description="Asegúrate de que tu cuenta esté protegida con una contraseña larga y aleatoria"
                />

                <!-- ✅ Mensaje de éxito -->
                <p v-if="page.props.status" class="text-sm text-green-600 dark:text-green-400">
                    {{ page.props.status }}
                </p>
